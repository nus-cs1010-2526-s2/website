...
This is part of the CS1010 formative assessment. Submit before 3 Mar (Wed), 2pm to receive feedback and earn your achievement badges.
...
```
username@xcnd0:~/ex02-githubid$ ./lemon
1 4 3
1
4
7
...
```
username@xcnd0:~/ex02-githubid$ ./factor
48
8
username@xcnd0:~/ex02-githubid$ ./factor
49
...
```
username@xcnd0:~/ex02-albertsutz$ ./parity
123456
odd: 3
even: 3
username@xcnd0:~/ex02-albertsutz$ ./parity
...
```
username@xcnd0:~/ex02-githubid$ ./nine
900
3
username@xcnd09:~/ex02-githubid$ ./nine
9999999
1
username@xcnd0:~/ex02-githubid$ ./nine
123456780
...
```
username@xcnd0:~/2122s1/ex02-githubid$ ./hdb
3 3
###
###
###
...
```
username@xcnd0:~/ex02-githubid$ ./binary
1101
13
username@xcnd0:~/ex02-githubid$ ./binary
111
...
```
username@xcnd0:~/ex02-githubid$ ./onigiri
5
    #     
   ###    
  #####   
...
```
username@xcnd0:~/ex02-githubid$ ./onigiri | sed 's/ /./g'
4
...#...
..###..
.#####.
...
### Sample Runs
```
username@xcnd0:~/ex02-githubid$ ./fibonacci
1
1
username@xcnd0:~/ex02-githubid$ ./fibonacci
10
...
```
username@xcnd0:~/ex02-githubid$ ./collatz
1 1
0
1
username@xcnd0:~/ex02-githubid$ ./collatz
...
```
username@xcnd0:~/ex02-githubid$ ./rectangle
2 2
╔╗
╚╝
username@xcnd0:~/ex02-githubid$ ./rectangle
...
```
username@xcnd0:~/ex02-githubid$ ./prime
2
2
username@xcnd0:~/ex02-githubid$ ./prime
10
...
```
username@xcnd0:~/ex02-githubid$ ./pattern
2 4
   #   
  #.#  
 ##.## 
