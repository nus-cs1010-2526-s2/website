...
```
username@pe112:~/ex02-username$ ./lemon
1 4 3
1
4
7
...
```
username@pe112:~/ex02-username$ ./factor
48
8
username@pe112:~/ex02-username$ ./factor
49
...
```
username@pe119:~/ex02-albertsutz$ ./parity
123456
odd: 3
even: 3
username@pe119:~/ex02-albertsutz$ ./parity
...
```
username@pe119:~/ex02-username$ ./nine
900
3
username@pe119:~/ex02-username$ ./nine
9999999
...
```
username@pe119:~/2122s1/ex02-username$ ./hdb
3 3
###
###
###
...
```
username@pe113:~/ex02-username$ ./binary
1101
13
username@pe113:~/ex02-username$ ./binary
111
...
```
username@pe112:~/ex02-username$ ./onigiri
5
    #     
   ###    
  #####   
...
```
username@pe112:~/ex02-username$ ./onigiri | sed 's/ /./g'
4
...#...
..###..
.#####.
...
### Sample Runs
```
username@pe113:~/ex02-username$ ./fibonacci
1
1
username@pe113:~/ex02-username$ ./fibonacci
10
...
```
username@pe114:~/ex02-username$ ./collatz
1 1
0
1
username@pe114:~/ex02-username$ ./collatz
...
```
username@pe113:~/ex02-username$ ./rectangle
2 2
╔╗
╚╝
username@pe113:~/ex02-username$ ./rectangle
...
```
username@pe113:~/ex02-username$ ./prime
2
2
username@pe113:~/ex02-username$ ./prime
10
...
```
username@pe114:~/ex02-username$ ./pattern
2 4
   #   
  #.#  
 ##.## 
