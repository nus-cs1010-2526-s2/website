...
```
username@pe119:~/ex06-skeleton$ cat inputs/sort.1.in
5
5 4 2 1 3
username@pe119:~/ex06-skeleton$ ./sort < inputs/sort.1.in
1
2
3
4
...
```
username@pe119:~/ex06-skeleton$ cat inputs/valley.1.in
5
5 4 2 1 3
username@pe119:~/ex06-skeleton$ ./sort < inputs/valley.1.in
1
```
...
### Sample Runs
```
username@pe119:~/ex06-weitsang$ cat inputs/inversion.1.in
5
1 3 5 4 2
username@pe119:~/ex06-weitsang$ ./inversion < inputs/inversion.1.in
4
username@pe119:~/ex06-weitsang$ cat inputs/inversion.2.in
3
1 20 300
username@pe119:~/ex06-weitsang$ ./inversion < inputs/inversion.2.in
0
username@pe119:~/ex06-weitsang$ cat inputs/inversion.3.in
1
-100
username@pe119:~/ex06-weitsang$ ./inversion < inputs/inversion.3.in
0
```
...
### Sample Runs
```
username@pe119:~/ex06-weitsang$ cat inputs/marks.1.in
3
Armin 70
Eren 80
Mikasa 60
username@pe119:~/ex06-weitsang$ ./marks < inputs/marks.1.in
60 Mikasa
70 Armin
80 Eren
username@pe119:~/ex06-weitsang$ cat inputs/marks.2.in
4
Annie 80
Levi  90
Sasha 80
Zeke  90
username@pe119:~/ex06-weitsang$ ./marks < inputs/marks.2.in
80 Annie
80 Sasha
90 Levi
90 Zeke
