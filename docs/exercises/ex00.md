...
The link to accept the exercise on GitHub Classroom is not available publicly. Visit [Canvas](https://canvas.nus.edu.sg/courses/85271) for the link.

### Deadline

This is part of CS1010 formative assessment. Submit before 3 Feb (Tue), 2pm to receive feedback and earn your achievement badges.
...
```
username@pe111:~/ex00-username$ ./echo
123
123
username@pe111:~/ex00-username$ ./echo
-1
...
The text `username@pe111:~/ex00-username$` is the command prompt.  Yours will look different, of course.  `echo` is the executable you created.  The next line, `123`, is the input you provide.  Press enter after the input.  `123` is the output printed by `echo`.
...
```
username@pe111:~/ex00-username$ ./divide
10 2
5.0000
username@pe111:~/ex00-username$ ./divide
1 2
...
```
username@pe111:~/ex00-username$ ./ones
10
0
1
username@pe111:~/ex00-username$ ./ones
...
```
username@pe111:~/ex00-username$ ./bmi
100.0 50
50.0000
username@pe111:~/ex00-username$ ./bmi
182.9 70.125
...
```
username@pe111:~/ex00-username$ ./quadratic
1.0 -2.0 1.0
1.0000
1.0000
username@pe111:~/ex00-username$ ./quadratic
...
### Sample Runs
```
username@pe111:~/ex00-username$ ./cuboid
3 4 12
192
13.0000
username@pe111:~/ex00-username$ ./cuboid
