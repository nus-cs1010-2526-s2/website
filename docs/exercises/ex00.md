...
```
username@xcnd0:~/ex00-githubid$ ./echo
123
123
username@xcnd0:~/ex00-githubid$ ./echo
-1
...
The text `username@xcnd0:~/ex00-githubid$` is the command prompt.  Yours will look different, of course.  `echo` is the executable you created.  The next line, `123`, is the input you provide.  Press enter after the input.  `123` is the output printed by `echo`.
...
```
username@xcnd0:~/ex00-githubid$ ./divide
10 2
5.0000
username@xcnd0:~/ex00-githubid$ ./divide
1 2
...
```
username@xcnd0:~/ex00-githubid$ ./ones
10
0
1
username@xcnd0:~/ex00-githubid$ ./ones
...
```
username@xcnd0:~/ex00-githubid$ ./bmi
100.0 50
50.0000
username@xcnd0:~/ex00-githubid$ ./bmi
182.9 70.125
...
```
username@xcnd0:~/ex00-githubid$ ./quadratic
1.0 -2.0 1.0
1.0000
1.0000
username@xcnd0:~/ex00-githubid$ ./quadratic
...
### Sample Runs
```
username@xcnd0:~/ex00-githubid$ ./cuboid
3 4 12
192
13.0000
username@xcnd0:~/ex00-githubid$ ./cuboid
