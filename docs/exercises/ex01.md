...
This is part of CS1010 formative assessment. Submit before 13 Feb (Fri), 2pm to receive feedback and earn your achievement badges.
...
```
username@pe112:~/ex01-username$ ./odd
1234
1235
username@pe112:~/ex01-username$ ./echo
-1
1
```
...
```
username@pe111:~/ex01-username$ ./sum
123456
-100
123456
username@pe111:~/ex01-username$ ./sum
...
The main function has been given to you in the file `candy-main.c`.  You should not change this file.  Write your solution in the file `candy.c`.

### Sample Runs

```
username@pe111:~/ex01-username$ ./candy
8 2
4
username@pe111:~/ex01-username$ ./candy
8 3
...
$$\sqrt{s \times x \times y \times z}$$

where $s$ is $\frac{1}{16}$ of the perimeter:

$$s = \frac{a}{16} + \frac{b}{16} + \frac{c}{16}$$
...
- Pay attention to the type of the parameters for functions `is_possible_triangle` and `compute_area`.
- The equations above are presented in a way that reduces that maginitude of the values involved in the computation, to avoid overflow or imprecision.  If you calculate the area in another way, it might lead to a different answer, even if your formulate is mathematically equivalent.

### Sample Runs

```
username@pe111:~/ex01-username$ ./triangle
3 4 5
Possible
6.0000
username@pe111:~/ex01-username$ ./triangle
...
```
username@pe112:~/ex01-username$ ./leap
1995
...
### Sample Runs
```
username@pe112:~/ex01-username$ ./multiple
3 8
false
username@pe112:~/ex01-username$ ./multiple
8 2
...
```
username@pe112:~/ex01-username$ ./date
1 1
12 31
6 6
no
...
```
username@pe112:~/ex01-username$ ./pressure
80 50
low
username@pe112:~/ex01-username$ ./pressure
100 50
...
```
username@pe112:~/ex01-username$ ./gcd
48 32
16
username@pe112:~/ex01-username$ ./gcd
1 1
...
### Sample Runs
```
username@pe111:~/ex01-username$ ./digits
1933091
1514
username@pe111:~/ex01-username$ ./digits
10
...
### Sample Runs
```
username@pe111:~/ex01-username$ ./power
2 3
8
username@pe111:~/ex01-username$ ./power
1 0
...
```
username@pe112:~/ex01-username$ ./suffix
2
2nd
username@pe112:~/ex01-username$ ./suffix
13
...
### Example 1
```
username@pe111:~/ex01-username$ ./taxi
1 17 59 1000
3.9000
```
