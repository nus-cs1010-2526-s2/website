...
```
username@xcnd0:~/ex01-githubid$ ./odd
1234
1235
username@xcnd0:~/ex01-githubid$ ./echo
-1
1
```
...
```
username@xcnd0:~/ex01-githubid$ ./sum
123456
-100
123456
username@xcnd0:~/ex01-githubid$ ./sum
...
```
username@xcnd0:~/ex01-githubid$ ./candy
8 2
4
username@xcnd0:~/ex01-githubid$ ./candy
8 3
...
```
username@xcnd0:~/ex01-githubid$ ./triangle
3 4 5
Possible
6.0000
username@xcnd0:~/ex01-githubid$ ./triangle
...
```
username@xcnd0:~/ex01-githubid$ ./leap
1995
...
### Sample Runs
```
username@xcnd0:~/ex01-githubid$ ./multiple
3 8
false
username@xcnd0:~/ex01-githubid$ ./multiple
8 2
...
```
username@xcnd0:~/ex01-githubid$ ./date
1 1
12 31
6 6
no
...
```
username@xcnd0:~/ex01-githubid$ ./pressure
80 50
low
username@xcnd0:~/ex01-githubid$ ./pressure
100 50
...
```
username@xcnd0:~/ex01-githubid$ ./gcd
48 32
16
username@xcnd0:~/ex01-githubid$ ./gcd
1 1
...
### Sample Runs
```
username@xcnd0:~/ex01-githubid$ ./digits
1933091
1514
username@xcnd0:~/ex01-githubid$ ./digits
10
...
### Sample Runs
```
username@xcnd0:~/ex01-githubid$ ./power
2 3
8
username@xcnd0:~/ex01-githubid$ ./power
1 0
...
```
username@xcnd0:~/ex01-githubid$ ./suffix
2
2nd
username@xcnd0:~/ex01-githubid$ ./suffix
13
...
### Example 1
```
username@xcnd0:~/ex01-githubid$ ./taxi
1 17 59 1000
3.9000
```
