...
This is part of the CS1010 formative assessment. Submit before 20 Mar (Fri), 2pm to receive feedback and earn your achievement badges.
...
### Sample Runs
```
username@xcnd0:~/ex04-username$ ./word
hello
hello
username@xcnd0:~/ex04-username$ ./word
...
### Sample Runs
```
username@xcnd0:~/ex04-username$ ./line
hello
hello
username@xcnd0:~/ex04-username$ ./line
Bye bye, see you later!
...
### Sample Runs
```
username@xcnd0:~/ex04-username$ ./up
hello
HELLO
username@xcnd0:~/ex04-username$ ./up
Bye bye, see you later!
...
```
username@pe101:~/ex04-username$ ./list
3
100 -120 130
130
-120
...
```
username@pe101:~/ex04-username$ ./length
Hello world!
13
```
...
```
username@pe101:~/ex04-username$ ./concat
cs
1010
cs1010
```
...
```
username@pe118:~/ex04-username$ ./kendall
3
2 3 1
0.6667
username@pe118:~/ex04-username$ ./kendall
...
```
username@pe101:~/ex04-username$ ./search
haystack
1
needle
not found
...
```
username@pe119:~/ex04-username$ ./subtract
2 1
1
username@pe119:~/ex04-username$ ./subtract
10 9
